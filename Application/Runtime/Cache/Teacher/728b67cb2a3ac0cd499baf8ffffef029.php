                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    <tbody>
                      <tbody>
                        ...
                        <td><?php if($vo['state'] == 1): ?>未选题<?php elseif($vo['state'] == 2): ?>选题已通过e<?php elseif($vo['state'] == 3): ?>选题未通过<?php elseif($vo['state'] == 4): ?>已提交开题报告和开题PPT<?php elseif($vo['state'] == 5): ?>已提交论文和答辩PPT<?php endif; ?></td>
