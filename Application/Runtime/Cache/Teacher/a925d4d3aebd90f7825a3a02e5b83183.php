    ...
    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><div class="col-sm-6 col-md-3" margin="100px 50px">
        <div class="thumbnail" >
            ...
            <div class="caption">
                ...
                <p>
                    <a href="/ActivityManage/index.php/Teacher/Activity/pass?id=<?php echo ($vol["a_id"]); ?>" class="btn btn-primary" role="button">
                        通过审核
                    </a>
                    <a href="/ActivityManage/index.php/Teacher/Activity/downloads?url=<?php echo ($vol["a_application_url"]); ?>"  class="btn btn-default" role="button">
                        下载申请文档
                    </a>
                    <a href="/ActivityManage/index.php/Teacher/Activity/reject?id=<?php echo ($vol["a_id"]); ?>" class="btn btn-primary" role="button">
                        不合格
                    </a>
                </p>
            </div>
