      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li><a href="/ActivityManage/index.php/Student/Activity/applyUnpassActivity?id=<?php echo (session('id')); ?>"><i class="fa fa-bar-chart-o"></i> 未通过审核的活动</a></li>
          </ul>
    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            <table class="table table-hover">
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><h1>未通过审核的活动</h1>
                <thead>
                <tr>
                    <th>活动编号</th>
                    <th>活动名称</th>
                ...
                <tbody>
                <tr>
                    <td><?php echo ($vol["a_id"]); ?></td>
                    <td><?php echo ($vol["a_name"]); ?></td>
