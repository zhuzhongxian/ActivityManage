...
<table class="table table-striped">
    ...
    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tbody>
    <tr>
        <td><?php echo ($vol["a_id"]); ?></td>
        <td><?php echo ($vol["a_name"]); ?></td>
        <td><?php echo ($vol["a_place"]); ?></td>
        <td><?php echo ($vol["a_describe"]); ?></td>
    </tr>
