...
<html lang="en">
  ...
  <body>
        ...
        <div class="row">
            <div class="table-responsive">
              ...
              <td>审核不通过</td><?php endif; ?>  
                  <td><a href="/paper/index.php/Admin/Student/auditingtitle/id/<?php echo ($vo["id"]); ?>/status/1">通过审核</a>|<a href="/paper/index.php/Admin/Student/auditingtitle/id/<?php echo ($vo["id"]); ?>/status/2">不通过审核</a></td> 
    ...
    <script src="/paper/Public/Admin/js/common.js"></script>
  <!-- JavaScript -->
