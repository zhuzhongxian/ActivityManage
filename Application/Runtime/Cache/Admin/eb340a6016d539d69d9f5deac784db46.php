           ...
           <!--  <li><a href="bootstrap-grid.html"><i class="fa fa-wrench"></i> Bootstrap Grid</a></li> -->
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="/ActivityManage/index.php/Admin/User/showTeacher">教师管理</a></li>
            ...
            <li><a href="/ActivityManage/index.php/Admin/Student/showGrade"><i class="fa fa-bar-chart-o"></i> 学生成绩</a></li>
          </ul>
...
<table class="table table-striped">
  ...
  <tbody>
    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
      ...
      <td><a class="btn btn-default" href="/ActivityManage/index.php/Admin/User/editUser/id/<?php echo ($vol["id"]); ?>/type/<?php echo ($vol["type"]); ?>" role="button">修改</a>
      <a class="btn btn-primary" href="/ActivityManage/index.php/Admin/User/del/id/<?php echo ($vol["id"]); ?>/type/<?php echo ($vol["type"]); ?>" role="button">删除</a></td>
