...
<div class="page-header" style=" padding: 30px 100px 0px 325px">
   <h2>修改信息</h2>
	...
	<form class="form-horizontal"  role="form" style="padding: 100px 400px 10px 0px"  method="post" action="/ActivityManage/index.php/Admin/Organization/edit/">
      <input type="hidden" name="org_id" value="<?php echo ($data["org_id"]); ?>">
  <input type="hidden" name="org_name1" value="<?php echo ($data["org_name"]); ?>">
      <input type="hidden" name="org_describe1" value="<?php echo ($data["org_describe"]); ?>">
  
  <div class="form-group" style=" padding: 0px 0px 10px 00px">
    <label for="lastname" class="col-sm-2 control-label">修改组织名称</label>
    <div class="col-sm-10">
      ...
      <div class="form-group" style=" padding: 0px 0px 10px 00px">
        <label for="lastname" class="col-sm-2 control-label">修改组织描述</label>
        <div class="col-sm-10">
          <input type="text" class="form-control"  name="org_describe" />
        </div>
      </div>
