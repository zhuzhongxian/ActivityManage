		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
					...
					<!-- Start Sign In Form -->
					<form action="/paper/index.php/Admin/Login/sign_in" class="fh5co-form animate-box" data-animate-effect="fadeIn">
						<h2>教师注册</h2>
						...
						<div class="col-md-6">
						<div class="form-group">
							<input type="submit" value="去登录" class="btn btn-primary">
						</div>
					</div>
					</div>
					</form>
