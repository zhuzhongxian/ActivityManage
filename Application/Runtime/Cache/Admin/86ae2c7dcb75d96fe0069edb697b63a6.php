...
<table class="table table-striped">
  ...
  <tbody>
    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
     ...
     <!--  <td><a class="btn btn-default" href="/paper/index.php/Admin/Student/edit/id/<?php echo ($vol["id"]); ?>" role="button">修改</a>
      <a class="btn btn-primary" href="/paper/index.php/Admin/Student/del/id/<?php echo ($vol["id"]); ?>" role="button">删除</a></td> -->
