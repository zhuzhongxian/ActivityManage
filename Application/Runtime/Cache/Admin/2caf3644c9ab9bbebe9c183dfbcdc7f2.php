...
<body>
	<form action="/ActivityManage/index.php/Admin/Department/into/" enctype="multipart/form-data" method="post" class="form-inline" role="form" style=" padding: 50px 80px 10px 350px" >
...
<p>
  <a href="/ActivityManage/index.php/Admin/Index/downloads/name/department" class="btn btn-primary btn-lg btn-block" role="button" >下载系部数据模版</a>
</p>
