...
<table class="table table-striped">
  ...
  <tbody>
    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
      ...
      <td><a class="btn btn-default" href="/ActivityManage/index.php/Admin/Organization/edit/id/<?php echo ($vol["org_id"]); ?>" role="button">修改</a>
      <a class="btn btn-primary" href="/ActivityManage/index.php/Admin/Organization/del/id/<?php echo ($vol["org_id"]); ?>" role="button">删除</a></td>
