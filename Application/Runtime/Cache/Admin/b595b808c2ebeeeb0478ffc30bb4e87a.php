...
<div class="panel panel-success" style="padding: 60px 50px 10px;">
    <div class="panel-heading" >
        <h1 class="panel-title" style="padding: 60px 50px 10px;"  font-size: 30px;> <span  style="color: rgb(74, 0, 0); font-size: 30px; padding: 90px 0px 0px -5px">活动管理</span> </h1>
    </div>
